...
export const ui = {
  el: {
    ...
    "page.istoria.image_alt":
      "Το σύνολο της θεατρικής ομάδας «Από Κοινού» στη σκηνή.",
    ...
    "page.404.body": "Η σελίδα που ζητήσατε δεν υπάρχει ή έχει μετακινηθεί.",
  ...
  en: {
    ...
    "page.404.body": "The page you requested does not exist or has moved.",
